...
public class NotificationService {
    ...
    public List<ArenNotification> getNotifications(String auth0Id) {
        return notificationRepository.findByUserAuth0IdOrderByCreatedAtDesc(auth0Id);
    }
    ...
    public void markAllAsRead(String auth0Id) {
        notificationRepository.markAllAsRead(auth0Id);
    }
}