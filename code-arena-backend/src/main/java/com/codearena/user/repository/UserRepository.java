/*
 * MERGED: UserRepository.java
 * Base: TARGET — findByAuth0Id, findByKeycloakId alias, leaderboard queries
 * Added from SOURCE: findByRole(Role role) — required by module7_coaching
 */
...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    // Added from SOURCE — used by module7_coaching
