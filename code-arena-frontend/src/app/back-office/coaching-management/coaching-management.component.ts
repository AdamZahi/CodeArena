...
@Component({
  selector: 'app-coaching-management',
  standalone: true,
      ...
      <div class="dashboard-container">
        ...
        <div class="lc-header-main">
          <div class="header-text">
            <h1 class="glitch-title">ADMIN_<span>COACHING_PANEL</span></h1>
  ...
  styles: [`
    ...
    .lc-container {
      min-height: calc(100vh - 64px); background: var(--dark); font-family: 'Rajdhani', sans-serif; color: var(--text);
...
export class CoachingManagementComponent implements OnInit {
