...
export const BO_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'battles', loadChildren: () => import('./battle-management/battle-management.routes').then((m) => m.BATTLE_MANAGEMENT_ROUTES) },      { path: 'shop', loadChildren: () => import('./shop-management/shop-management.routes').then((m) => m.SHOP_MANAGEMENT_ROUTES) },
